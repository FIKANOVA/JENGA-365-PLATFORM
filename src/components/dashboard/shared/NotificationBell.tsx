    ...
    return (
        <div ref={ref} className="relative">
            ...
            >
                ...
                {unreadCount > 0 && (
                    <span
                        className="absolute -top-1 -right-1 min-w-[16px] h-4 px-1 rounded-full text-label font-bold text-white flex items-center justify-center border-2 border-background"
