...
export default function ChoosePathSection() {
    ...
    const [activeTab, setActiveTab] = useState<"mentee" | "mentor" | "corporate" | "ngo">("mentee");
    ...
    return (
        <section className="bg-background border-y border-border py-12 md:py-20 md:py-32">
