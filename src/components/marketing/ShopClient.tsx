...
import { CheckCircle, X, Package, Search, ShoppingBag, ShoppingCart, Ban, PackageX } from "lucide-react";
                                ...
                                {orderConfirmation.items.map((item, i) => (
                                    <div key={i} className="flex items-center justify-between gap-4">
                                        <div className="flex items-center gap-3 min-w-0">
                                            <Package size={14} className="text-[var(--foreground-subtle)] shrink-0" />
