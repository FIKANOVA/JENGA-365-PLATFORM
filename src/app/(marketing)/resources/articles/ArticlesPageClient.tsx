            ...
            <main>
                ...
                <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
                    ...
                    <div className="flex flex-wrap items-center gap-6 border-b border-border pb-10 mb-16">
                        <span className="text-eyebrow text-[var(--foreground-subtle)]">Filter</span>
                        ...
                        {filteredArticles.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-12 md:py-24 text-center space-y-6">
                                ...
                                <button
                                    ...
                                    className="px-8 py-3 border border-border text-black text-eyebrow hover:bg-black hover:text-white transition-all"
                                >
                                    Reset Filters
                                </button>
                            </div>
