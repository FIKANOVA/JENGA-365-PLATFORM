...
export default function VoicesPage() {
    return (
        <div className="flex flex-col bg-[var(--surface-1)]">
            <section className="bg-[var(--surface-1)] border-b border-[var(--border)] pt-40 pb-28">
                <div className="max-w-7xl mx-auto px-6 md:px-12">
                    <div className="max-w-3xl space-y-8">
                        <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-[var(--brand-green)] block">
                            Stories
                        </span>
                        <h1 className="font-serif font-black text-6xl md:text-8xl text-black uppercase leading-[0.9] tracking-tighter">
                            Community<br />
                            <span className="italic text-[var(--brand-green)]">Voices.</span>
                        </h1>
                        <p className="text-xl text-[var(--foreground-muted)] font-light leading-relaxed max-w-2xl">
            ...
            <section className="py-28">
                <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
                    <Mic className="h-20 w-20 text-[var(--border)] mx-auto mb-8" />
                    <h2 className="font-serif font-black text-4xl uppercase tracking-tighter text-black mb-4">Stories Coming Soon</h2>
                    <p className="text-[var(--foreground-subtle)] font-light max-w-md mx-auto">
